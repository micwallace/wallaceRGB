...
public class AppIndicatorTray {
    ...
    private WallaceLED app;
    
    @Inject
    public AppIndicatorTray(WallaceLED mainWindow) {
        this.app = mainWindow;
    }
    ...
    public void createTray() {
        ...
        TitleItem = libgtk.gtk_menu_item_new_with_label("WallaceLED");
        ...
        openItem = libgtk.gtk_menu_item_new_with_label("Show"); // XXX i18n
        ...
        appIndicator = libappindicator.app_indicator_new("wallaceled", "indicator-messages-new",AppIndicator.CATEGORY_APPLICATION_STATUS);
        ...
        changeIcon(WallaceLED.class.getProtectionDomain().getCodeSource().getLocation().getPath()+"WallaceLED.png");
